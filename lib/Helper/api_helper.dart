class APIHelper {
  ...
  static const String APP_CONFIG_DOCTOR = '$PREFIX_API/api/v1/AppConfigs/2';
  ...
  static const String DOCTOR_OLD_APPOINTMENT =
      '$PREFIX_API/api/v1/Doctors/BookAppointment';
}
