...
class DependentHealthRecordScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BaseView<DependentHealthRecordViewModel>(
  ...
  DefaultTabController _tabView1(
      BuildContext context, DependentHealthRecordViewModel model) {
    return DefaultTabController(
      length: 6,
      child: Scaffold(
        appBar: new AppBar(
  ...
  Widget _tabView2(BuildContext context, DependentHealthRecordViewModel model) {
...
//TabBarView for Tình trạng lúc sinh
  Widget _tabView3(BuildContext context, DependentHealthRecordViewModel model) {
...
//TabBarView for Tiền sử bệnh tật, dị ứng
  Widget _tabView4(BuildContext context, DependentHealthRecordViewModel model) {
    return SingleChildScrollView(
      child: Container(
        child: Column(
          children: <Widget>[
...
//TabBarView for khuyết tật
  Widget _tabView5(BuildContext context, DependentHealthRecordViewModel model) {
    return SingleChildScrollView(
      child: Container(
        child: Column(
          children: <Widget>[
...
//TabBarView for Tiền sử phẫu thuật
  Widget _tabView6(BuildContext context, DependentHealthRecordViewModel model) {
    return SingleChildScrollView(
      child: Container(
        child: Column(
          children: <Widget>[
...
//TabBarView for Tiền sử gia đình
  Widget _tabView7(BuildContext context, DependentHealthRecordViewModel model) {
    return SingleChildScrollView(
      child: Container(
        child: Column(
          children: <Widget>[
...
//TabBarView for Vấn đề khác
  Widget _tabView8(BuildContext context, DependentHealthRecordViewModel model) {
    return SingleChildScrollView(
      child: Container(
        child: Column(
          children: <Widget>[
