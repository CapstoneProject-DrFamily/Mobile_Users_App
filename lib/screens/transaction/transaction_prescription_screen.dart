                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Visibility(
                                      visible:
                                          model.list[index].morningQuantity !=
                                                      0 &&
                                                  model.list[index]
                                                          .morningQuantity !=
                                                      null
                                    ...
                                    SizedBox(height: 10),
                                    Visibility(
                                      visible: model.list[index].noonQuantity !=
                                                  0 &&
                                    ...
                                    Visibility(
                                      visible:
                                          model.list[index].afternoonQuantity !=
                                                      0 &&
                                                  model.list[index]
                                                          .afternoonQuantity !=
                                                      null
                                        ...
                                        Expanded(
                                          child: Padding(
                                            padding: const EdgeInsets.only(
                                                left: 8, right: 8),
                                            child: Text(
                                              model.list[index].totalQuantity
                                                  .toString(),
                                              style: TextStyle(
                                                  fontSize: 20,
                                                  color: Colors.white),
                                        ...
                                        Expanded(
                                          child: Padding(
                                            padding: const EdgeInsets.only(
                                                left: 8, right: 8),
                                            child: Text(
                                              model.list[index].type.toString(),
                                              style: TextStyle(
                                                  fontSize: 20,
                                                  color: Colors.white),
                                            ),
                                          ...
                                          Expanded(
                                            child: Padding(
                                              padding: const EdgeInsets.only(
                                                  left: 8, right: 8),
                                              child: Text(
                                                model.list[index].method == null
                                                    ? ''
                                                    : model.list[index].method
                                                        .toString(),
                                                style: TextStyle(
                                                    fontSize: 20,
                                                    color: Colors.white),
